---
name: "source-command-ux-product-review"
...
# source-command-ux-product-review

Use this skill when the user asks to run the migrated source command `ux-product-review`.
