...
[ -f pom.xml ] && grep -q "spring-boot" pom.xml 2>/dev/null && echo "FRAMEWORK:springboot"
...
Options: A) Node.js/TypeScript B) Java/Spring Boot C) Go D) Ruby/Rails E) Python F) Rust G) Elixir H) This project doesn't need tests.
...
| Java/Spring Boot | JUnit 5 + Mockito + Spring Boot Test | — |
